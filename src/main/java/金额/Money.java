 ...
 *
 * @author guangdong.li
 * @version $Id: Money.java, v 0.1 2014-4-21 下午3:32:38  Exp $
 */
    ...
    public String toLevelString() {
        ...
        if (wan < 10000) {
            ...
            if (StringUtils.endsWith(wanStr, ".00") || StringUtils.endsWith(wanStr, ".0")) {
                return StringUtils.substring(wanStr, 0, wanStr.indexOf("."))
                        + LevelEnum.WAN.message;
            } else {
            ...
            if (StringUtils.endsWith(yiStr, ".00") || StringUtils.endsWith(yiStr, ".0")) {
                ...
                return StringUtils.substring(yiStr, 0, yiStr.indexOf(".") + 3)
                        + LevelEnum.YI.message;
            }
        }
    }
